        ...
        if opts.mode == 0:
            ...
            for step in range(max_len):
                ...
                with autocast():
                    ...
                    seg_scale = 1.0 if is_acdc else 1.0
                ...
                if (cur_itrs) % opts.val_interval == 0:
                    save_ckpt('checkpoints/main_mask2former_WAS_TAS_ON_Disable_WAS_TAS_latest.pth')
                    print("validation...")
                    model.eval()
                    ...
                    if val_score_cs['Mean IoU'] > best_score_cs:
                        ...
                        save_ckpt('checkpoints/main_mask2former_WAS_TAS_ON_Disable_WAS_TAS_best.pth')
